          ...
          <ul className="chat-list">
            {loading ? (
              ...
              chatList.map((chat) => (
                <li
                  key={chat.id}
                  className={`chat-list-item ${selectedChat === chat.id ? "selected-chat" : ""
                    }`}
          ...
          {!selectedChat && chatList.length === 0 && !loading ? (
            ...
            <>
              ...
              <div className="messages-container">
                {messages.map((msg) => {
                  const [type, applicantId] = msg.text.split('|');
                  ...
                  return (
                    ...
                    >
                      {type === "VIEW_CV_REQUEST" ? (
                        <div>
                          <strong>Jobseeker Request:</strong> <br />
                          <button
                            onClick={() => navigate('/recruiter_preview_cv', { state: { applicantId } })}
