...
const ViewApplicants = () => {
  ...
  const handleReject = async (applicantId) => {
    try {
      ...
      setRejectErrorMessage(error.message || "Something went wrong while rejecting.");
  ...
  return (
    ...
    <main className="view-applicants-container">
      ...
      {showRejectError && (
        <div className="confirmation-modal">
          <div className="confirmation-content">
            <h2>Failed to Reject Applicant</h2>
            <p className="confirmation-message">{rejectErrorMessage}</p>
            <div className="confirmation-buttons">
              <button
                className="confirm-button reject-btn"
